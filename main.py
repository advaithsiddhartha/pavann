...
st.success(
    "We're updating our app for enhanced functionalities. Here is a video of the prototype of the first version: (Last Updated : 5th October). ALL THE REGISTERED USERS WILL BE NOTIFIED ONCE WE COMPLETE THE UPDATION "
)

# Embed the updated YouTube video
video_url = "https://www.youtube.com/embed/2FBeQwbQXPA"
st.markdown(
    f'<iframe width="100%" height="411" src="{video_url}" frameborder="0" allowfullscreen></iframe>',
