...
st.success(
    "We're updating our app for enhanced functionalities. Here is a video of the prototype of the first version: (Last Updated : 7th October). ALL THE REGISTERED USERS WILL BE NOTIFIED ONCE WE COMPLETE THE UPDATION "
)
